...
from opentelemetry.context import get_value as otel_context_get_value
...
class TestLabelerContextVar(unittest.TestCase):
    ...
    def test_contextvar_name_and_api_consistency(self):
        self.assertTrue(LABELER_CONTEXT_KEY.startswith("otel_labeler-"))
        labeler = get_labeler()
        labeler.add("test", "value")
        ctx_labeler = otel_context_get_value(LABELER_CONTEXT_KEY)
    ...
    def test_clear_and_get_labeler_contextvar(self):
        labeler = get_labeler()
        labeler.add("test", "value")
        self.assertIs(otel_context_get_value(LABELER_CONTEXT_KEY), labeler)
        clear_labeler()
        self.assertIsNone(otel_context_get_value(LABELER_CONTEXT_KEY))
        new_labeler = get_labeler()
        self.assertIsNot(new_labeler, labeler)
        self.assertEqual(new_labeler.get_attributes(), {})
